...
if excsolve:
    ansatz = build_ansatz_excitations(graph)
...
qit_evolver.evolve(num_steps=100, lr=0.1, excsolve=excsolve, verbose=True)  # lr was 0.5
...
save_filename = "graph_conv.png"
title = f"ExcSolve: {excsolve}\n Scores: Base={base_score}, Balanced={balanced_score}, connected={connected_score}"
